...
export default function ClientDashboard() {
  ...
  useEffect(() => {
    ...
    if (activeUserId) {
      fetch(`${BASE_URL}/api/clients/${activeUserId}/bookings`)
        .then(res => res.json())
        .then(data => {
  ...
  const triggerStkPush = async (phone: string) => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/api/payments/stk-push`, {
        method: 'POST',
      ...
      <div className="grid gap-6 md:grid-cols-3 mb-8">
        <Card className="bg-slate-900 text-black shadow-xl border-none">
          ...
          <CardContent>
            ...
            <p className="text-[10px] mt-1 opacity-50 italic">
        ...
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent>
            ...
            <p className="text-[10px] mt-1 text-primary/70 italic uppercase tracking-tighter">
              Pending or Unpaid
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-[10px] mt-1 text-muted-foreground italic uppercase tracking-tighter">
              Total Transactions
            </p>
          </CardContent>
        </Card>
        ...
        <CardContent className="p-0">
          {dataLoading ? (
            ...
            <div className="py-24 text-center flex flex-col items-center gap-4">
              ...
              <Button asChild>
                <Link href="/vendors">Browse Services</Link>
              </Button>
            </div>
          ) : (
            <div className="divide-y divide-border/60">
              {bookings.map(booking => (
                <div
                  key={booking.id}
                  className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:bg-muted/5 transition-all"
                >
