// app/admin/new-registrations/page.tsx
'use client'
...
export default function NewRegistrationsPage() {
  ...
  if (loading)
    return (
      <div className="p-10 animate-pulse font-serif">
        Loading New Members...
      </div>
    )
    ...
    <div className="p-8 space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-500 italic">
          Latest members to join the Splendour platform
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {users.length > 0 ? (
          users.map((user) => (
            <Card
              key={user.id}
              className="border-none shadow-sm bg-white hover:border-l-4 hover:border-l-primary transition-all"
            >
